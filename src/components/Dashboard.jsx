...
export const Dashboard = () => {
  return (
    <div className="dash">
      <p>welcome!</p>
      <p id="info">Here is a breif overview of the webapp.</p>
      <div className="dash-list">
        <ul>
          <li>
            ...
            <p>
              This is the article editor for creating and posting new articles.
            </p>
          </li>
          <li>
            ...
            <p>
              This is for the main page, where you can view find and filter all
              of the articles.
            </p>
          </li>
          <li>
            ...
            <p>This is the user center, this are is stll under construction!</p>
          </li>
        </ul>
      </div>
    </div>
